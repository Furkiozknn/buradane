  ...
  return (
    <html lang="tr">
      <body className="antialiased">
        {/* The "Sonuç listesine geç" skip link lives in AppShell, next to
            the #sonuclar list it targets. Here it was on every page, and on
            /admin, /yer/[id] and the 404 it pointed at an id that does not
            exist: the first Tab stop went nowhere (axe: skip-link, region). */}
        {children}
